...
.mv_moovee-container.ticket-container {
  ...
  --mv-title-font-family: var(--font-sans);
  ...
  --mv-cinema-border-radius: 0;

  /* Button styling */
  --mv-button-padding: 0.425em 0.625em;
  --mv-button-font-family: var(--mv-font-family);
  --mv-button-font-size: 1em;
  --mv-button-font-weight: var(--mv-font-weight-medium);
  --mv-button-border-radius: var(--mv-border-radius);

  /* Primary (Solid) button */
  --mv-button-border-color: var(--mv-color-primary);
  --mv-button-border-color-hover: var(--mv-color-primary-hover);
  --mv-button-bg-color: var(--mv-color-primary);
  --mv-button-bg-color-hover: var(--mv-color-primary-hover);
  --mv-button-text-color: #fff;
  --mv-button-text-color-hover: #fff;

  /* Secondary (Outline) button */
  --mv-button-secondary-border-color: var(--mv-color-primary);
  --mv-button-secondary-border-color-hover: var(--mv-color-primary-hover);
  --mv-button-secondary-bg-color: transparent;
  --mv-button-secondary-bg-color-hover: var(--mv-color-primary-hover);
  --mv-button-secondary-text-color: var(--mv-color-primary);
  --mv-button-secondary-text-color-hover: #fff;

  --mv-button-performance-scale: 1;

  --mv-link-color: var(--mv-color-primary);
  --mv-link-color-hover: var(--mv-color-primary-hover);

  /* Tab styling */
  --mv-tab-text-color: var(--mv-color-base-600);
  --mv-tab-text-color-hover: var(--mv-color-primary);
  --mv-tab-active-text-color: var(--mv-color-base-900);
  --mv-tab-active-bg-color: var(--color-tertiary-lightest);
  ...
  --mv-input-active-text-color: #fff;
  --mv-input-active-bg: var(--mv-color-primary);

  /* Search */
  --mv-search-bg: #fff;
  --mv-search-border-color: var(--mv-color-base-100);
  ...
  --mv-search-focus-outline-color: var(--mv-color-base-200);
  ...
  --mv-search-suggestion-select-text: #fff;
  --mv-search-suggestion-select-bg: var(--color-tertiary-dark);
